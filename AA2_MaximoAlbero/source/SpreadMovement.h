...
class SpreadMovement : public EnemyMovement {
private:
...
public:
    SpreadMovement(Transform* transform, RigidBody* rigidBody, Vector2 startPosition, Vector2 targetPosition, float duration = 0.6f)
